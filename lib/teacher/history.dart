...
//                   child: Row(
//                     children: [
//                       Icon(Icons.view_timeline, color: Theme
//                           .of(context)
//                           .colorScheme
//                           .primary),
//                       Text(
...
//                 child: Row(
//                   crossAxisAlignment: CrossAxisAlignment.start,
//                   // Aligns texts at the top
//                   children: [
//                     Icon(
//                       Icons.rebase_edit, color: Colors.brown.withOpacity(0.7),),
//                     Text(
//                       'Instructions: ',
//                       style: TextStyle(
//                         color: Colors.brown,
...
//                         // Handle overflow if the text is too long
...
//                           ViewSubmissions(assignId: widget.assId, title: widget
//                               .title,)),
//                     );
//                   },
//                   child: Text('       View \n Submissions',
...
//                     context,
//                     MaterialPageRoute(builder: (context) =>
//                         DefaultersScreen(assId: widget.assId,)),
//                   );
//                 },
//                 child: Center(
//                   child: Visibility(
//                     visible: _timeUntil[0] == 'Blocked Assignment'
//                         ? true
//                         : false, // Set to false to hide the widget
//                     child: Row(
//                       children: [
//                         Icon(Icons.privacy_tip_outlined, color: Colors.red,),
//                         SizedBox(width: 5,),
//                         Text('View defaulter Students', style: TextStyle(
//                             color: Colors.red,
...
//         );
//
//         // After navigating back, change color to grey
//         setState(() {
//           colorPink = false;
//         });
//       },
...
//       //     child: CircleAvatar(
//       //       radius: 30.0,
//       //       backgroundImage: NetworkImage(widget.studentModel.photoUrl),
//       //     ),
//       //   ),
//       // ),
//     );
...
// //         //   scrollDirection: Axis.horizontal,
// //         //   children: allChatBubbles,
// //         //   // children:[Text('${allChatBubbles.length}')]
// //         // ),
// //       ),
// //     );
// //   }
